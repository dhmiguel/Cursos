...
public class Estoque {
	...
	public Estoque(int idEstoque, int idProduto, String dtEntrada, int quantidade, String dtFabricacao, String dtVencimento, String nfCompra, float precoCompra, float icmsCompra, float precoVenda, int qtdVendida, int qtdOcorrencia, String ocorrencia){
		this.tableName  = "estoque";
		this.fieldsName = "idEstoque, idProduto, dtEntrada, quantidade, dtFabricacao, dtVencimento, nfCompra, precoCompra, icmsCompra, precoVenda, qtdVendida, qtdOcorrencia, ocorrencia";
		this.keyField   = "idEstoque";
		this.dbQuery = new DBQuery(this.tableName, this.fieldsName, this.keyField);
	...
	public void	setIcmsCompra( float icmsCompra ){
		this.icmsCompra=icmsCompra;
	};
	
	public float	 getIcmsCompra(){
