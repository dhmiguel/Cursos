...
public class Produtos {
	...
	public Produtos(int idProduto, String fabricante, String nome, String marca, String modelo, int idCategoria, String descricao, String unidadeMedida, float largura, float altura, float profundidade, float peso, String cor, String dtFabricacao){
		this.tableName  = "produtos";
		this.fieldsName = "idProduto, fabricante, nome, marca, modelo, idCategoria, descricao, unidadeMedida, largura, altura, profundidade, peso, cor, dtFabricacao";
		this.keyField   = "idProduto";
		this.dbQuery = new DBQuery(this.tableName, this.fieldsName, this.keyField);
